...
export const projects: Project[] = [
	{
		...
		slug: 'trello-clone',
		summary:
			'What started as a way of learning Java & Spring Boot turned into a quest for pixel-perfect front-end imitation. React/TypeScript and Next.js deployed to Vercel with a Java Sping Boot back end deployed on Fly.io.',
		description:
